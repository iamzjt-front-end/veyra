...
Planner/reviewer adapter for the Gemini Developer API, with structured results, bounded HTTP transport and opt-in image understanding for documented model IDs. All input/output crosses `@veyraoss/protocol`; deadlines use `@veyraoss/runtime`.
